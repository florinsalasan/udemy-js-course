...
let bills2 = [10, 15, 100, 120, 230, 270, 300, 310, 350, 500]
let bills3 = [22, 295, 176, 440, 37, 105, 10, 1100, 86, 52]
let tips2 = []
let totals2 = []
let tips3 = []
let totals3 = []
...
for (let i = 0; i < bills2.length; i++) {
  tips2.push(Number(calcTip(bills2[i])))
  tips3.push(Number(calcTip(bills3[i])))
  totals2.push(tips2[i] + bills2[i])
  totals3.push(tips3[i] + bills3[i])
}
console.log(totals2, totals3)
