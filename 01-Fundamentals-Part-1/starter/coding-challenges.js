...
function totalBill(price) {
  const tipPercentage = 50 <= price && price <= 300 ? 0.15 : 0.2;
  // console.log(tipPercentage)
  const tip = price * tipPercentage
  const total = tip + price
  console.log(`The bill was ${price}, the tip was ${tip.toFixed(2)}, and the total value is ${total.toFixed(2)}`)
}
totalBill(275)
totalBill(40)
totalBill(430)